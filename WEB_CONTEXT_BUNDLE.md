...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-7520ce8f06c15b0f"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-7520ce8f06c15b0f",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-7520ce8f06c15b0f",
        "url": "https://en.wikipedia.org/wiki/Hilbert%27s_ninth_problem"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Hilbert's 9th problem : find the most general reciprocity law for the norm residues of $k$ -th order in a general algebraic number field , where $k$ is a power of a prime.",
      "version": 1
    },
    "title": "Hilbert's 9th problem",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "4af2086aed8d962cb20f305a5e26e8f03a8f7d09dcbc99463137693c4ab06a99"
}
```
